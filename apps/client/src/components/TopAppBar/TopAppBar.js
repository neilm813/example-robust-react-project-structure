    ...
    <AppBar position="static">
      <Container maxWidth="xl">
        <Toolbar disableGutters>
          <RouterLink to="/">
            <Box component="img" src={logoMonumentsPlane} alt="logo" sx={{ width: (theme) => theme.spacing(20) }} />
          </RouterLink>
          <Typography
            variant="h6"
            ...
            >
              {pages.map((page) => (
                <MenuItem key={page.path} onClick={handleCloseNavMenu}>
                  <Typography onClick={() => navigate(page.path)} color="primary" textAlign="center">
                    {page.text}
                  </Typography>
                </MenuItem>
              ))}
